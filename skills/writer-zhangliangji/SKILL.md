...
- 段落以短段高频为主，18-25段为宜，每段80-100字
- 典型节奏：短句开路（立观点）→长句展开（举例子、讲道理）→短句收束（给结论或金句）
- 短句（5-15字）占比约40-50%，用于点睛；长句（30-50字）用于铺陈
- 段末短句收束时，用”这就叫X””这就叫Y”的判断句式形成记忆点

### 铁律二：用词——公众号白话、金句点缀

- 以公众号直接说话的口吻为底色（”今天讲XX的干货””什么意思”）
- 金句（15%）：凝练的观点句，高度概括，如”理解规则，适应规则，最后利用规则”
- 概念引入（10%）：适当引入心理学/商业概念增加专业感（”心理学上有个概念，叫情绪耗竭”）
- 禁止浮华空泛修饰词堆叠
- 绝对禁止21世纪网络用语和新媒体腔（”绝绝子””emo了””破防了”）
- 固定结尾祝福语：”我是归云，与君共勉！”（改写任务专用）

### 铁律三：论证——观点+例证并列轰炸

- 核心论证模式：观点+多个”比如””再比如””就像”连续轰炸
- 每个观点后至少跟2个例证，例证要多样化（恋爱、职场、友情、生活）
- 类比用于降低理解门槛，每篇至少3个类比（商业/游戏/生活类比）
- 类比控制在1-2句话内完成，不展开
- 中段展开时语气平静，不用感叹号
...
- 禁止直接说”我很愤怒””这让我感动”
- 用具体场景和细节替代抽象情感描述
- 用对比（懂vs不懂）揭示道理，让结论自己浮现
- 短句收束，一针见血（如”主打一个欺软怕硬”）
- 不回避残酷，但也不渲染绝望——“看透后依然前行”的清醒现实主义

### 铁律五：引用——以我为主、经验说话

- 不依赖经典引用，主要用自身的经历和观察
- “我有一个朋友……””我刚进入XX行业的时候”的经历式引出
- 用具体场景细节替代权威引用
- 如需引用，用口语化方式（”马斯克说过……”而非”根据马斯克的观点”）

### 铁律五点五：开篇方式——直击主题、不绕弯子

- 模式A：身份标签开场——“所有……都……”的判断句式（”所有的人际关系，都逃不开价值交换”）
- 模式B：设问开场——自问自答，引导阅读节奏（”到底什么叫工作能力强？”）
- 模式C：故事开场——用”我”的日常经验开始，带场景感
- 绝对禁止：悬念式、数据轰炸式、绕弯子式、新闻导语式

### 铁律六：段落结构——短段高频、观点迭代

- 18-25段为宜，每段只讲一个意思，说完就换下一个
- 靠内容逻辑自然衔接，段落间禁止学术过渡词
- 首尾呼应：开篇的观点在结尾用金句升华
- 不使用小标题；如需，全篇最多2-3个，且必须口语化
- 收尾用警句或祝福收束，不超过2句话

### 铁律七：人称视角——经验分享者

- 「我」是经验分享者身份，引出故事/经历/观察，不强行输出观点
- 常用句式：”我刚进入……的时候””我有一个朋友””我自己就遇到过”
- 分享经历时口吻随意、带自嘲，绝不自我拔高
- 可以表达困惑（「我大惑不解」）、可以总结规律（「进而总结出一个规律」）
- 第二人称「你」用于设问引导（”问题是你想做从众的羊，还是勇猛的狮子？”），全文≤2次
...
6. **文件保存与输出格式（改写任务专用）**：
   - 改写完成后的文章必须保存到桌面「张良计风格文章」文件夹，文件名格式：`{年}{月}{日}{时}{分}_{文章标题}.md`，例如：`20250310_技术好的人为什么升不上去.md`（注意：月、日、时、分均为两位数，如03、10、20、30）
   - 文章开头第一句话必须是「你好，我是归云。」
   - 文章结尾最后一句话必须是「我是归云，与君共勉！」作为结束语
   - 文件格式为 Markdown (.md)
